...
```text
build/libs/js-secret-hunter-1.1.1.jar
```
...
- **Links:** قائمة مستقلة لمسارات API وadmin وGraphQL وWebSocket وروابط الخدمات والإعدادات المكتشفة.
...
تظهر النتائج داخل تبويبي **Findings** و**Links**. الكتابة في Proxy History Notes
